    ...
    movies: [
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/trainwreck.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/insideout.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/home.jpg",
      ...
      },
      {
        ...
        hinhAnh:
          "http://movienew.cybersoft.edu.vn/hinhanh/batmanvssuperman.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/antman.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/jurassicworld.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/fantasticfour.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/madmax.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/truedetective.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/thelongestride.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/thewalkingdead.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/southpaw.jpg",
      ...
      },
      {
        ...
        hinhAnh: "http://movienew.cybersoft.edu.vn/hinhanh/spectre.jpg",
      ...
      },
      {
        ...
        hinhAnh:
          "http://movienew.cybersoft.edu.vn/hinhanh/avengers-infinity-war.jpg",
  ...
  render() {
    return (
      <div className="container-fluid">
        <h1>Colors</h1>
        {/* dùng map để từ 1 array data ban đầu return về 1 array jsx và các phần tử jsx bên trong array mới sẽ được hiển thị ra giao diện */}
        {this.state.colors.map((color, index) => {
          // return về jsx
          // Khi dùng map để render jsx, bắt buộc phải có thuộc tính key ở tag html ngoài cùng
          return (
            <p key={index} className={`bg-${color}`}>
              {color}
            </p>
          );
        })}
